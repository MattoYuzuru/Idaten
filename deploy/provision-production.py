...
OPTIONAL_KEYS = {
    ...
    "AI_MAX_IMAGE_PIXELS",
    "AI_MAX_TEXT_CHARS",
    "AI_MONTHLY_GLOBAL_LIMIT",
    "AI_OPENAI_API_KEY",
    "AI_OPENAI_ENDPOINT",
    "AI_RETRIES",
    "AI_TASK_ACTIVITY_EXTRACTION_MODEL",
    "AI_TASK_ACTIVITY_EXTRACTION_PROVIDER",
    "AI_TASK_READINESS_EXTRACTION_MODEL",
    "AI_TASK_READINESS_EXTRACTION_PROVIDER",
    "AI_TASK_VOICE_TRANSCRIPTION_MODEL",
    "AI_TASK_VOICE_TRANSCRIPTION_PROVIDER",
    "AI_TIMEOUT_SECONDS",
