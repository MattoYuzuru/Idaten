...
- Draft PR: https://github.com/MattoYuzuru/Idaten/pull/6
...
- GitHub CI run `28897061906`: `backend`, `image`, `deployment`, `android` прошли;
  Android job собрал и проверил APK с repository signing secrets.
